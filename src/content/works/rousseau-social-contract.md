...
originalTitle: Du contrat social, ou Principes du droit politique
aliases: [Du contrat social, On the Social Contract, Of the Social Contract]
author: rousseau
year: 1762
era: enlightenment
region: france
...
genres: [treatise]
themes: [liberty, power-and-authority, society-and-the-state, justice, god-and-faith]
difficulty: 3
length: short
pages: 110
recommendedEdition:
...
synopsis: >-
  ...
  the only rightful state is one in which each person hands himself entirely to the whole community and, obeying the
  general will, obeys a will that is partly his own. Sovereignty on this account cannot be represented, divided or
  given away; government is only its hired agent. The four books treat the contract, the nature of sovereignty and
  law, the forms and diseases of government, and the institutions, ending with civil religion, that keep a republic
  from dying.
whyItMatters: >-
  Every modern claim that a government's authority comes from the people rather than from God, conquest or custom
  runs through this book. It supplied the vocabulary of the French Revolution, the theory behind popular sovereignty
  and referendums, and the standing objection to purely representative government: Rousseau says a people that elects
  deputies has already sold its freedom. It also supplied the most disputed sentence in political philosophy, the one
  about forcing a man to be free, which critics from Constant to Berlin read as the blueprint for totalitarian
  democracy and defenders read as a description of what any law does. Programs assign it as the third point of the
  triangle with Hobbes and Locke, and because it makes the reader decide what a people is before deciding what it may
  do.
keyThemes:
  - theme: liberty
    note: >-
      Rousseau distinguishes natural, civil and moral freedom, and claims the last one, obedience to a law you helped
      make, is the only kind available to people who live together.
  - theme: power-and-authority
    note: >-
      Sovereignty belongs to the assembled people and cannot be delegated. What we call the government is an employee
      that can be dismissed, and usually the thing that kills the state.
  - theme: society-and-the-state
    note: >-
      The general will is not a majority vote but what the citizens will insofar as they will the common good, which
      leaves open the awkward question of who can tell the difference.
  - theme: justice
    note: >-
      Law must be general in both its source and its object. A decree aimed at a particular person is not a law at
      all, whatever assembly passed it.
  - theme: god-and-faith
    note: >-
      The closing chapter on civil religion proposes a minimal state creed and the banishment of anyone who will not
      profess it, which is where many readers stop being sympathetic.
highlights:
  - text: >-
    ...
    note: >-
      L'homme est ne libre, et partout il est dans les fers. The next sentence is the important one: he says he does
      not know how this happened, but he can say what makes it legitimate.
  - text: >-
      Whoever refuses to obey the general will shall be compelled to do so by the whole body; which means nothing
      other than that he will be forced to be free.
    location: "Book 1, chapter 7"
    translator: Editor's literal rendering
    note: The sentence the whole later argument about Rousseau turns on. Read the paragraph around it before deciding what it means.
  - text: >-
      Find a form of association that defends each member with the whole common force, and in which each, uniting
      with all, still obeys only himself and remains as free as before.
    location: "Book 1, chapter 6"
    translator: Editor's literal rendering
    note: Paraphrase of his statement of the problem the contract is meant to solve. Everything after it is the proposed solution.
  - text: >-
      The English people believes itself free; it is gravely mistaken. It is free only during the election of members
      of parliament, and is a slave as soon as they are chosen.
    location: "Book 3, chapter 15"
    translator: Editor's literal rendering
    note: Paraphrase. His objection to representation is the part of the book that modern democracies least like to quote.
  - text: >-
      There is no religion so false that it contains nothing true, and no state was ever founded without religion
      serving as its base.
    location: "Book 4, chapter 8"
    translator: Editor's literal rendering
    note: Paraphrase of the argument leading to the civil profession of faith, the chapter that got the book burned in Geneva.
related: [rousseau-discourse-on-inequality, hobbes-leviathan, locke-second-treatise-of-government, tocqueville-democracy-in-america]
keywords: [general will, sovereignty, legislator, civil religion, Sparta, Geneva, popular sovereignty, forced to be free]
status: draft
updated: 2026-09-21
---
## Overview
